      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Select defaultValue="Jobs" sx={{ minWidth: 150 }}>
            <MenuItem value="Jobs">Projects</MenuItem>
          </Select>
          ...
          <Box sx={{ display: "flex", gap: 2 }}>
            ...
            <Button variant="contained" sx={{ backgroundColor: '#1976d2' }}>Add Project</Button>
          </Box>
        </Box>
        ...
        <Box sx={{
          ...
          />
          <Typography>No Projects added currently. To add new Projects, click Add Project</Typography>
        </Box>
      </Box>
    </Box>
  );
